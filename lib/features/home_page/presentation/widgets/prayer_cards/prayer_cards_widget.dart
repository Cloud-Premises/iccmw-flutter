      ...
      child: Wrap(
        ...
        children: [
          SizedBox(
            ...
            child: _buildPrayerCardStyleTwo(
              ...
              imagePath: 'assets/images/home_page/masjidNowNew.png',
          ...
          children: [
            SizedBox(
              width: (MediaQuery.of(context).size.width - 42) /
                  2, // Width for 2 items per row
              height: 160, // Set an appropriate height for the shimmer card
